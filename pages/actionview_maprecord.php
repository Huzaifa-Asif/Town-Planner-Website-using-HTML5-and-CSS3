	     ...
	     <table  class="table table-striped table-bordered">
                            ...
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <th>Remarks</th>
                                    <th>Description</th>
                                    <th>Map Record Date</th>
                                    <th>Due Clearence Date</th>
                            ...
                            <tbody>
							<?php 
							$query=mysql_query("select * from map_record where m_date like '".$_POST['month']."/__/".$_POST['year']."' ORDER BY map_Id")or die(mysql_error());
                         ...
                         <?php
                            ...
                            $result1 = mysql_query("SELECT sum(m_duepayment) FROM map_record where m_date like '".$_POST['month']."/__/".$_POST['year']."' ") or die(mysql_error());
                            ...
                            ?>
						        ...
						        <?php
                            $result = mysql_query("SELECT sum(m_totalpayment) FROM map_record where m_date like '".$_POST['month']."/__/".$_POST['year']."' ") or die(mysql_error());
                            ...
                            ?>
                              ...
                              <?php
                            $result = mysql_query("SELECT sum(m_totalpayment) - sum(m_duepayment) FROM map_record where m_date like '".$_POST['month']."/__/".$_POST['year']."' ") or die(mysql_error());
                            while ($rows = mysql_fetch_array($result)) {
                                ?>

                                <div class="pull-right">
                                    <div class="span"><div class="alert alert-success"><i class="icon-credit-card icon-large"></i>&nbsp;Total Profit:&nbsp;<?php echo $rows['sum(m_totalpayment) - sum(m_duepayment)']; ?></div></div>
                                </div>
                            <?php }
                           ?>
