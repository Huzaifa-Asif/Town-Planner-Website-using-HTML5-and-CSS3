...
<br /> 
	     ...
	     <table  class="table table-striped table-bordered">
                            ...
                            <tbody>
							<?php 
							$query=mysql_query("select * from monthly_expense where m_date like '".$_POST['month']."/__/".$_POST['year']."' ORDER BY me_ID")or die(mysql_error());
                         ...
                         <?php
                            ...
                            $result1 = mysql_query("SELECT sum(m_amount) FROM monthly_expense where m_date like '".$_POST['month']."/__/".$_POST['year']."' ") or die(mysql_error());
                            ...
                            ?>
						        ...
						        <?php
                            $result = mysql_query("SELECT count(me_ID) FROM monthly_expense where m_date like '".$_POST['month']."/__/".$_POST['year']."' ") or die(mysql_error());
