...
<br /> 
	     ...
	     <table  class="table table-striped table-bordered">
                            ...
                            <tbody>
							<?php 
							$query=mysql_query("select * from survey where survey_date like '".$_POST['month']."/__/".$_POST['year']."' ORDER BY survey_Id")or die(mysql_error());
                         ...
                         <?php
                            ...
                            $result1 = mysql_query("SELECT sum(survey_amount) FROM survey where survey_date like '".$_POST['month']."/__/".$_POST['year']."' ") or die(mysql_error());
                            ...
                            ?>
						        ...
						        <?php
                            $result = mysql_query("SELECT count(survey_Id) FROM survey where survey_date like '".$_POST['month']."/__/".$_POST['year']."' ") or die(mysql_error());
