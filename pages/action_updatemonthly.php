...
<?php 
        ...
        if(isset($_POST['me_Id']))
        {
            ...
            $sql = "UPDATE monthly_expense SET m_name ='".$_POST['m_name']."' , m_amount ='".$_POST['m_amount']."', m_description ='".$_POST['m_description']."', m_date ='".$_POST['m_date']."'   WHERE me_Id=".$_POST['me_Id']."";
