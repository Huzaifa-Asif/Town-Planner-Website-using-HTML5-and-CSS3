...
<br /> 
	     ...
	     <table  class="table table-striped table-bordered">
                            ...
                            <tbody>
							<?php 
							$query=mysql_query("select * from position_record where p_date like '".$_POST['month']."/__/".$_POST['year']."' ORDER BY position_Id")or die(mysql_error());
                         ...
                         <?php
                            ...
                            $result1 = mysql_query("SELECT sum(p_payment) FROM position_record where p_date like '".$_POST['month']."/__/".$_POST['year']."' ") or die(mysql_error());
                            ...
                            ?>
						        ...
						        <?php
                            $result = mysql_query("SELECT count(position_ID) FROM position_record where p_date like '".$_POST['month']."/__/".$_POST['year']."' ") or die(mysql_error());
