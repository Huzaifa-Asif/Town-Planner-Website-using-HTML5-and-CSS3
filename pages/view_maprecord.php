...
<div class="container">
  ...
  <div class="alert alert-success">Map Records</div>
<br /> 
	     ...
	     <table  class="table table-striped table-bordered">
                            ...
                            <tbody>
							<?php 
							$query=mysql_query("select * from map_record ORDER BY map_Id")or die(mysql_error());
                         ...
                         <?php
                            ...
                            $result1 = mysql_query("SELECT sum(m_duepayment) FROM map_record") or die(mysql_error());
                            ...
                            ?>
						        ...
						        <?php
                            $result = mysql_query("SELECT sum(m_totalpayment) FROM map_record") or die(mysql_error());
                            ...
                            ?>
                              ...
                              <?php
                            $result = mysql_query("SELECT sum(m_advancepayment) FROM map_record") or die(mysql_error());
                            while ($rows = mysql_fetch_array($result)) {
                                ?>
