...
<?php 
        ...
        {
            $sql = "INSERT INTO monthly_expense (me_Id, flat_rent, shop_items, stationary, comp_repair, map_stamp, map_printing, me_date)
            VALUES ('".$_POST['me_Id']."', '".$_POST['flat_rent']."', '".$_POST['shop_items']."', '".$_POST['stationary']."', '".$_POST['comp_repair']."', '".$_POST['map_stamp']."', '".$_POST['map_printing']."', '".$_POST['me_date']."')";
