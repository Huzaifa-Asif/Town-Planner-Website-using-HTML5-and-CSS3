...
<?php 
        ...
        {
            $sql = "INSERT INTO map_record (map_Id,  m_totalpayment, m_advancepayment, m_duepayment, remarks, description, m_date )
            VALUES ('".$_POST['map_Id']."', '".$_POST['m_totalpayment']."', '".$_POST['m_advancepayment']."', '".$_POST['m_duepayment']."', '".$_POST['remarks']."', '".$_POST['description']."', '".$_POST['m_date']."')";
