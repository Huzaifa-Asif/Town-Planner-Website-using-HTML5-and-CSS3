...
<?php 
        ...
        {
            $sql = "INSERT INTO worker (worker_Id, worker_name, worker_address, worker_cellNo , join_date)
            VALUES ('".$_POST['worker_Id']."', '".$_POST['worker_name']."', '".$_POST['worker_address']."', '".$_POST['worker_cellNo']."', '".$_POST['join_date']."')";
