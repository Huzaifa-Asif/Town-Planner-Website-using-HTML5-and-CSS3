<html>
    ...
    <body style="color: #FFFFFF; background-image: url('background.jpg')">
     <?php 
        ...
        {
            $sql = "INSERT INTO survey (survey_Id, survey_location, survey_amount, survey_date)
            VALUES ('".$_POST['survey_Id']."', '".$_POST['survey_location']."', '".$_POST['survey_amount']."', '".$_POST['survey_date']."')";
