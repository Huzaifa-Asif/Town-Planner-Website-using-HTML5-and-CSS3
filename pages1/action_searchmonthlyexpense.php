       ...
       $conn = mysqli_connect('localhost', 'huzaifa8580', 'huzaifa', 'rehman1');
        ...
        if ($conn->connect_error) 
        {
            die("Connection failed: " . $conn->connect_error);
               ...
               $sql = "SELECT *FROM monthly_expense where me_date like '%".$_POST['me_date']."%'" ;
...
<th>Monthly Expense ID</th>
<th>Flat Rent</th>
<th>Shop Items</th>
<th>Stationary</th>
<th>Computer Repairing</th>
<th>Map Stamp</th>
<th>Map Printing</th>
<th>  Date  </th>
  ...
  echo "<td>" . $row['map_printing'] . "</td>";
    ...
    <body style="background-image: url('3d4094302fcbe09bea847b8cf9c4c3bd.png'); background-attachment: fixed; height: 42px; width: 1058px;">
	 <a class="auto-style5" href="search_eventmonthlyexpense.php"><strong><span class="auto-style6">
