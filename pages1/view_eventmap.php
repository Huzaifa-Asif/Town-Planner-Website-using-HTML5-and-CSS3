...
.auto-style1 {
    ...
    <?php 
       $conn = mysqli_connect('localhost', 'huzaifa8580', 'huzaifa', 'rehman1');
        ...
        $sql = "SELECT map_Id, m_totalpayment, m_advancepayment, m_duepayment, remarks, description, m_date, dp_date   FROM map_record order by map_Id";
